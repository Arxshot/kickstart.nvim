  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map('gri', '<cmd>FzfLua lsp_incoming_calls<cr>', '[G]oto [I]ncoming Calls')
        map('gro', '<cmd>FzfLua lsp_outgoing_calls<cr>', '[G]oto [O]utgoing Calls')
        ...
        map('grO', '<cmd>FzfLua diagnostics_document<cr>', 'Open Document Diagnostics')

        map('grW', '<cmd>FzfLua diagnostics_workspace<cr>', 'Open Workspace Diagnostics')

        -- Jump to the type of the word under your cursor<ScrollWheelUp>
