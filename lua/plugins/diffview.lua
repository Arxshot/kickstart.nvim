return {
  ...
  keys = {
    ...
    { { 'n', 'x' }, '2do', require('diffview.actions').diffget 'ours', { desc = 'Obtain the diff hunk from the OURS version of the file' } },
    { { 'n', 'x' }, '3do', require('diffview.actions').diffget 'theirs', { desc = 'Obtain the diff hunk from the THEIRS version of the file' } },
    { 'n', 'g?', require('diffview.actions').help { 'view', 'diff3' }, { desc = 'Open the help panel' } },

    -- Mappings in 4-way diff layouts
    { { 'n', 'x' }, '1do', require('diffview.actions').diffget 'base', { desc = 'Obtain the diff hunk from the BASE version of the file' } },
    { { 'n', 'x' }, '2do', require('diffview.actions').diffget 'ours', { desc = 'Obtain the diff hunk from the OURS version of the file' } },
    { { 'n', 'x' }, '3do', require('diffview.actions').diffget 'theirs', { desc = 'Obtain the diff hunk from the THEIRS version of the file' } },
    ...
    { 'n', 'X', require('diffview.actions').restore_entry, { desc = 'Restore file to the state from the selected entry' } },
    { 'n', 'zo', require('diffview.actions').open_fold, { desc = 'Expand fold' } },
    { 'n', 'zc', require('diffview.actions').close_fold, { desc = 'Collapse fold' } },
    { 'n', 'h', require('diffview.actions').close_fold, { desc = 'Collapse fold' } },
    { 'n', 'za', require('diffview.actions').toggle_fold, { desc = 'Toggle fold' } },
